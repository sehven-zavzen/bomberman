...
function denekAnim() {
	...
	var options = {imageSource: '/../client/img/bombReal.png', positionX: 50, positionY: 50, numberOfFrames: 12, canvas: canvas, spriteWidth: 216, spriteHeight: 20, ticksPerFrame: 10, repeat: 'forever'};
